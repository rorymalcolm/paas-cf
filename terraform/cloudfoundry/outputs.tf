output "cf1_subnet_id" {
  value = element(concat(aws_subnet.cf.*.id, [""]), 0)
}

output "cf2_subnet_id" {
  value = element(concat(aws_subnet.cf.*.id, [""]), 1)
}

output "cf3_subnet_id" {
  value = element(concat(aws_subnet.cf.*.id, [""]), 2)
}

output "cell1_subnet_id" {
  value = element(concat(aws_subnet.cell.*.id, [""]), 0)
}

output "cell2_subnet_id" {
  value = element(concat(aws_subnet.cell.*.id, [""]), 1)
}

output "cell3_subnet_id" {
  value = element(concat(aws_subnet.cell.*.id, [""]), 2)
}

output "router1_subnet_id" {
  value = element(concat(aws_subnet.router.*.id, [""]), 0)
}

output "router2_subnet_id" {
  value = element(concat(aws_subnet.router.*.id, [""]), 1)
}

output "router3_subnet_id" {
  value = element(concat(aws_subnet.router.*.id, [""]), 2)
}
...
output "aws_backing_service_ip_range_start" {
  value = cidrhost(var.aws_backing_service_cidrs["zone0"], 0)
}
...
output "ipsec_subnet_cidr_blocks" {
  value = concat(aws_subnet.cell.*.cidr_block, aws_subnet.router.*.cidr_block)
}
